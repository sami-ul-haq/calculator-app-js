...
function formatResult(result){
    const max_output_num_lenght = 10;
    const output_precision = 5;
    
    if( digitCounter(result) > max_output_num_lenght){
        if( isFloat(result) ){
            const result_int = parseInt(result);
            const result_int_length = digitCounter(result_int);

            if( result_int_length > max_output_num_lenght ){
                return result.toPrecision(output_precision);
            }
            else{
                const num_of_digit_after_point = max_output_num_lenght - result_int_length;
                return result.toFixed(num_of_digit_after_point)
            }
        }
        else{
